...
`ifdef XIL_TIMING
  ...
  assign CAS_IN_RDACCESS_A_in = CAS_IN_RDACCESS_A_delay;
  assign CAS_IN_RDACCESS_B_in = CAS_IN_RDACCESS_B_delay;
  ...
  assign EN_A_in = (EN_A !== 1'bz) && (EN_A_delay ^ IS_EN_A_INVERTED_BIN); // rv 0
  assign EN_B_in = (EN_B !== 1'bz) && (EN_B_delay ^ IS_EN_B_INVERTED_BIN); // rv 0
  ...
  assign RDB_WR_A_in = (RDB_WR_A !== 1'bz) && (RDB_WR_A_delay ^ IS_RDB_WR_A_INVERTED_BIN); // rv 0
  assign RDB_WR_B_in = (RDB_WR_B !== 1'bz) && (RDB_WR_B_delay ^ IS_RDB_WR_B_INVERTED_BIN); // rv 0
  assign RST_A_in = (RST_A !== 1'bz) && (RST_A_delay ^ IS_RST_A_INVERTED_BIN); // rv 0
  assign RST_B_in = (RST_B !== 1'bz) && (RST_B_delay ^ IS_RST_B_INVERTED_BIN); // rv 0
  assign SHUTDOWN_in = (SHUTDOWN !== 1'bz) && SHUTDOWN_delay; // rv 0
...
`else
  ...
  assign EN_A_in = (EN_A !== 1'bz) && (EN_A ^ IS_EN_A_INVERTED_BIN); // rv 0
  assign EN_B_in = (EN_B !== 1'bz) && (EN_B ^ IS_EN_B_INVERTED_BIN); // rv 0
  ...
  assign RDB_WR_A_in = (RDB_WR_A !== 1'bz) && (RDB_WR_A ^ IS_RDB_WR_A_INVERTED_BIN); // rv 0
  assign RDB_WR_B_in = (RDB_WR_B !== 1'bz) && (RDB_WR_B ^ IS_RDB_WR_B_INVERTED_BIN); // rv 0
  assign RST_A_in = (RST_A !== 1'bz) && (RST_A ^ IS_RST_A_INVERTED_BIN); // rv 0
  assign RST_B_in = (RST_B !== 1'bz) && (RST_B ^ IS_RST_B_INVERTED_BIN); // rv 0
  assign SHUTDOWN_in = (SHUTDOWN !== 1'bz) && SHUTDOWN; // rv 0
...
`ifdef XIL_XECLIB
  assign AUTO_SLEEP_LATENCY_BIN = AUTO_SLEEP_LATENCY_REG;

  assign AVG_CONS_INACTIVE_CYCLES_BIN = AVG_CONS_INACTIVE_CYCLES_REG;
  ...
  assign IS_EN_A_INVERTED_BIN = IS_EN_A_INVERTED_REG;

  assign IS_EN_B_INVERTED_BIN = IS_EN_B_INVERTED_REG;

  assign IS_RDB_WR_A_INVERTED_BIN = IS_RDB_WR_A_INVERTED_REG;
  
  assign IS_RDB_WR_B_INVERTED_BIN = IS_RDB_WR_B_INVERTED_REG;
  
  assign IS_RST_A_INVERTED_BIN = IS_RST_A_INVERTED_REG;

  assign IS_RST_B_INVERTED_BIN = IS_RST_B_INVERTED_REG;
  ...
  assign SELF_ADDR_A_BIN = SELF_ADDR_A_REG;

  assign SELF_ADDR_B_BIN = SELF_ADDR_B_REG;

  assign SELF_MASK_A_BIN = SELF_MASK_A_REG;

  assign SELF_MASK_B_BIN = SELF_MASK_B_REG;
