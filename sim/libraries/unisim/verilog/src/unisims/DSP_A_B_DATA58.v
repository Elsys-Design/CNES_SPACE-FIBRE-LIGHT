...
// define constants
  localparam MODULE_NAME = "DSP_A_B_DATA58";
...
`ifdef XIL_TIMING
  ...
  wire RSTA_delay;
  wire RSTB_delay;
  wire [23:0] BCIN_delay;
  wire [23:0] B_delay;
  wire [33:0] ACIN_delay;
  wire [33:0] A_delay;
`endif
...
`ifdef XIL_TIMING
  ...
  assign A_in[30] = (A[30] === 1'bz) || A_delay[30]; // rv 1
  assign A_in[31] = (A[31] === 1'bz) || A_delay[31]; // rv 1
  assign A_in[32] = (A[32] === 1'bz) || A_delay[32]; // rv 1
  assign A_in[33] = (A[33] === 1'bz) || A_delay[33]; // rv 1
  ...
  assign B_in[18] = (B[18] === 1'bz) || B_delay[18]; // rv 1
  assign B_in[19] = (B[19] === 1'bz) || B_delay[19]; // rv 1
  assign B_in[1] = (B[1] === 1'bz) || B_delay[1]; // rv 1
  assign B_in[20] = (B[20] === 1'bz) || B_delay[20]; // rv 1
  assign B_in[21] = (B[21] === 1'bz) || B_delay[21]; // rv 1
  assign B_in[22] = (B[22] === 1'bz) || B_delay[22]; // rv 1
  assign B_in[23] = (B[23] === 1'bz) || B_delay[23]; // rv 1
  ...
  assign RSTA_in = RSTA_delay ^ IS_RSTA_INVERTED_REG;
...
`ifndef XIL_XECLIB
  ...
  #1;
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-105] BCASCREG attribute is set to %d.  Legal values for this attribute are 1, 0 or 2. Instance: %m", MODULE_NAME, BCASCREG_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-106] BMULTSEL attribute is set to %s.  Legal values for this attribute are B or AD. Instance: %m", MODULE_NAME, BMULTSEL_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
        ((BREG_REG != 1) &&
         (BREG_REG != 0) &&
         (BREG_REG != 2))) begin
      $display("Error: [Unisim %s-107] BREG attribute is set to %d.  Legal values for this attribute are 1, 0 or 2. Instance: %m", MODULE_NAME, BREG_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-108] B_INPUT attribute is set to %s.  Legal values for this attribute are DIRECT or CASCADE. Instance: %m", MODULE_NAME, B_INPUT_REG);
      attr_err = 1'b1;
    end
  ...
  if ((attr_test == 1'b1) ||
    ...
    $display("Error: [Unisim %s-109] DSP_MODE attribute is set to %s.  Legal values for this attribute are INT24, CINT18, FP32 or INT8. Instance: %m", MODULE_NAME, DSP_MODE_REG);
      attr_err = 1'b1;
    end
  ...
  if ((attr_test == 1'b1) ||
    ...
    $display("Error: [Unisim %s-112] RESET_MODE attribute is set to %s.  Legal values for this attribute are SYNC or ASYNC. Instance: %m", MODULE_NAME, RESET_MODE_REG);
    attr_err = 1'b1;
  end
...
// begin behavioral model
  ...
  reg [A_WIDTH-1:0] A1_reg = {A_WIDTH{1'b0}};
  reg [A_WIDTH-1:0] A2_reg = {A_WIDTH{1'b0}};
  wire [B_WIDTH-1:0] B_BCIN_mux;
  reg [B_WIDTH-1:0] B1_DATA_out = {B_WIDTH{1'b0}};
  reg [B_WIDTH-1:0] B2_reg = {B_WIDTH{1'b0}};
...
//*********************************************************
    ...
    wire CEA2_int;
    assign CEA2_int = ((DSP_MODE_BIN == DSP_MODE_CINT18) && (AREG_BIN == 2'b01)) ? CEA1_in : CEA2_in;
...
// assumes encoding the same for ACASCREG and AREG
    ...
    assign A_TO_D_CPLX = (DSP_MODE_BIN != DSP_MODE_CINT18) ? 18'b0 :
                         (A_INPUT_BIN == A_INPUT_CASCADE) ? ACIN_in[17:0] : A_in[17:0];

    assign A_CPLX = A_ALU[17:0];
...
`ifndef XIL_XECLIB
  specify
    ...
    (A *> ACOUT) = (0:0:0, 0:0:0);
    (A *> A_ALU) = (0:0:0, 0:0:0);
    (A *> A_CPLX) = (0:0:0, 0:0:0);
    (A *> A_TO_D_CPLX) = (0:0:0, 0:0:0);
    (ACIN *> A2_DATA) = (0:0:0, 0:0:0);
    (ACIN *> ACOUT) = (0:0:0, 0:0:0);
    (ACIN *> A_ALU) = (0:0:0, 0:0:0);
    (ACIN *> A_CPLX) = (0:0:0, 0:0:0);
    ...
    (CLK *> A1_DATA) = (100:100:100, 100:100:100);
    (CLK *> A2_DATA) = (100:100:100, 100:100:100);
    (CLK *> ACOUT) = (100:100:100, 100:100:100);
    (CLK *> A_ALU) = (100:100:100, 100:100:100);
    (CLK *> A_CPLX) = (100:100:100, 100:100:100);
    (CLK *> B1_DATA) = (100:100:100, 100:100:100);
    (CLK *> B2_DATA) = (100:100:100, 100:100:100);
    (CLK *> BCOUT) = (100:100:100, 100:100:100);
    (CLK *> B_ALU) = (100:100:100, 100:100:100);
`ifdef XIL_TIMING
