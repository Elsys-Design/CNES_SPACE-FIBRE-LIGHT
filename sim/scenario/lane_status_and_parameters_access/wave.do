...
add wave -noupdate -expand -group DUT -expand -group PHY_PLUS_LANE -expand -group LANE -group PARALLELE_LOOPBACK /configuration_2_bench/spacefibre_instance/inst_phy_plus_lane/inst_parallel_loopback/VALID_K_CHARAC_TO_LCWD
...
add wave -noupdate -expand -group DUT -expand -group PHY_PLUS_LANE -expand -group LANE -group RX_SYNCHRONISATION_FSM /configuration_2_bench/spacefibre_instance/inst_phy_plus_lane/inst_rx_sync_fsm/VALID_K_CHARAC_TO_LCWD
...
add wave -noupdate -expand -group DUT -expand -group PHY_PLUS_LANE -expand -group LANE -group RX_SYNCHRONISATION_FSM /configuration_2_bench/spacefibre_instance/inst_phy_plus_lane/inst_rx_sync_fsm/VALID_K_CHARAC_FROM_IP
