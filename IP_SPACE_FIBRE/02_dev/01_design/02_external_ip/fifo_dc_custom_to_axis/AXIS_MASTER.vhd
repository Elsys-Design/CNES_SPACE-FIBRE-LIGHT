...
-- Délai sur les données d'entrée pour se synchroniser avec tlast                                           
	...
	begin                                                                                                                                     
	   if(m00_axis_aresetn = '0') then                                                                                                              
	       ...
	       case (mst_exec_state) is  
            when IDLE => 
                -- Dernière donnée en attente de tready pour être lue et nouvelle trame à lire
                if end_frame = '1' and m00_axis_tready = '0' and rd_data_vld = '1' then
                    mst_exec_state  <= WAIT_READY; 
                    axis_tvalid     <= '0';
                
                -- Dernière donnée en attente de tready pour être lue
                elsif end_frame = '1' and m00_axis_tready = '0' and rd_data_vld = '0' then
                    mst_exec_state  <= IDLE; 
                    
                -- Nouvelle trame à lire mais attente de tready
	            elsif rd_data_vld = '1' and m00_axis_tready = '0' then    
	                mst_exec_state  <= WAIT_READY; 
	                axis_tvalid     <= '0'; 
                    axis_tlast      <= '0';
                  
                -- Début de lecture d'une nouvelle trame  
            ...
            when SEND_STREAM  =>  
                -- Cas particulier : une seule donnée 
                if start_frame = '1' and m00_axis_tready = '0' and rd_data_vld = '0' then
                    mst_exec_state <= WAIT_READY; 
	                axis_tvalid    <= '0' ;  
	                end_frame      <= '1';

                -- Lecture pas commencée en attente tready
	            ...
	            -- Dernière donnée à lire en attente de tready
	        ...
	        when WAIT_READY =>
	           ...
	           -- Derniere donnée lue puis attente d'une nouvele trame
	          ...
	          -- Dernière donnée lue et nouvelle trame à lire
