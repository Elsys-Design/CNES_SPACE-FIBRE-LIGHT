...
//  /   /                        288K-bit Dual Port Synchronous Block RAM
...
`endif
  ...
  wire [22:0] ADDR_A_BUS;
  assign ADDR_A_BUS = cg_one ? {ADDR_A} : 22'bz;

  wire [22:0] ADDR_B_BUS;
  assign ADDR_B_BUS = cg_one ? {ADDR_B} : 22'bz;

  URAM288_INT #(.AUTO_SLEEP_LATENCY(AUTO_SLEEP_LATENCY), .AVG_CONS_INACTIVE_CYCLES(AVG_CONS_INACTIVE_CYCLES), .BWE_MODE_A(BWE_MODE_A),
                .BWE_MODE_B(BWE_MODE_B), .CASCADE_ORDER_A(CASCADE_ORDER_A), .CASCADE_ORDER_B(CASCADE_ORDER_B),
                .EN_AUTO_SLEEP_MODE(EN_AUTO_SLEEP_MODE), .EN_ECC_RD_A(EN_ECC_RD_A), .EN_ECC_RD_B(EN_ECC_RD_B),
                .EN_ECC_WR_A(EN_ECC_WR_A), .EN_ECC_WR_B(EN_ECC_WR_B), .IREG_PRE_A(IREG_PRE_A), .IREG_PRE_B(IREG_PRE_B),
                .IS_CLK_INVERTED(IS_CLK_INVERTED), .IS_EN_A_INVERTED(IS_EN_A_INVERTED), .IS_EN_B_INVERTED(IS_EN_B_INVERTED),
                .IS_RDB_WR_A_INVERTED(IS_RDB_WR_A_INVERTED), .IS_RDB_WR_B_INVERTED(IS_RDB_WR_B_INVERTED), .IS_RST_A_INVERTED(IS_RST_A_INVERTED),
                .IS_RST_B_INVERTED(IS_RST_B_INVERTED), .OREG_A(OREG_A), .OREG_B(OREG_B), .OREG_ECC_A(OREG_ECC_A), .OREG_ECC_B(OREG_ECC_B),
                .REG_CAS_A(REG_CAS_A), .REG_CAS_B(REG_CAS_B), .RST_MODE_A(RST_MODE_A), .RST_MODE_B(RST_MODE_B),
                .SELF_ADDR_A(SELF_ADDR_A), .SELF_ADDR_B(SELF_ADDR_B), .SELF_MASK_A(SELF_MASK_A), .SELF_MASK_B(SELF_MASK_B),
                .USE_EXT_CE_A(USE_EXT_CE_A), .USE_EXT_CE_B(USE_EXT_CE_B) ) URAM288_i (
...
`else
  localparam [3:0] AUTO_SLEEP_LATENCY_REG = AUTO_SLEEP_LATENCY;
  localparam [16:0] AVG_CONS_INACTIVE_CYCLES_REG = AVG_CONS_INACTIVE_CYCLES;
...
`endif
  ...
  localparam[3:0] AUTO_SLEEP_LATENCY_BIN = 4'b0;
  localparam[16:0] AVG_CONS_INACTIVE_CYCLES_BIN = 17'b0;
  localparam[0:0] BWE_MODE_A_BIN = 1'b0;
  localparam[0:0] BWE_MODE_B_BIN = 1'b0;
  localparam[1:0] CASCADE_ORDER_A_BIN = 2'b0;
  localparam[1:0] CASCADE_ORDER_B_BIN = 2'b0;
  localparam[0:0] EN_AUTO_SLEEP_MODE_BIN = 1'b0;
  localparam[0:0] EN_ECC_RD_A_BIN = 1'b0;
  localparam[0:0] EN_ECC_RD_B_BIN = 1'b0;
  localparam[0:0] EN_ECC_WR_A_BIN = 1'b0;
  localparam[0:0] EN_ECC_WR_B_BIN = 1'b0;
  localparam[0:0] IREG_PRE_A_BIN = 1'b0;
  localparam[0:0] IREG_PRE_B_BIN = 1'b0;
  localparam[0:0] IS_CLK_INVERTED_BIN = 1'b0;
  localparam[0:0] IS_EN_A_INVERTED_BIN = 1'b0;
  localparam[0:0] IS_EN_B_INVERTED_BIN = 1'b0;
  localparam[0:0] IS_RDB_WR_A_INVERTED_BIN = 1'b0;
  localparam[0:0] IS_RDB_WR_B_INVERTED_BIN = 1'b0;
  localparam[0:0] IS_RST_A_INVERTED_BIN = 1'b0;
  localparam[0:0] IS_RST_B_INVERTED_BIN = 1'b0;
  localparam[0:0] OREG_A_BIN = 1'b0;
  localparam[0:0] OREG_B_BIN = 1'b0;
  localparam[0:0] OREG_ECC_A_BIN = 1'b0;
  localparam[0:0] OREG_ECC_B_BIN = 1'b0;
  localparam[0:0] REG_CAS_A_BIN = 1'b0;
  localparam[0:0] REG_CAS_B_BIN = 1'b0;
  localparam[0:0] RST_MODE_A_BIN = 1'b0;
  localparam[0:0] RST_MODE_B_BIN = 1'b0;
  localparam[10:0] SELF_ADDR_A_BIN = 11'b0;
  localparam[10:0] SELF_ADDR_B_BIN = 11'b0;
  localparam[10:0] SELF_MASK_A_BIN = 11'b0;
  localparam[10:0] SELF_MASK_B_BIN = 11'b0;
  localparam[0:0] USE_EXT_CE_A_BIN = 1'b0;
  localparam[0:0] USE_EXT_CE_B_BIN = 1'b0;
...
`ifdef XIL_XECLIB
  ...
  // wire IS_EN_A_INVERTED_BIN;
  // wire IS_EN_B_INVERTED_BIN;
  // wire IS_RDB_WR_A_INVERTED_BIN;
  // wire IS_RDB_WR_B_INVERTED_BIN;
  // wire IS_RST_A_INVERTED_BIN;
  // wire IS_RST_B_INVERTED_BIN;
  // wire OREG_A_BIN;
  // wire OREG_B_BIN;
  // wire OREG_ECC_A_BIN;
  // wire OREG_ECC_B_BIN;
  ...
  // wire RST_MODE_A_BIN;
  // wire RST_MODE_B_BIN;
  // wire [10:0] SELF_ADDR_A_BIN;
  // wire [10:0] SELF_ADDR_B_BIN;
  // wire [10:0] SELF_MASK_A_BIN;
  // wire [10:0] SELF_MASK_B_BIN;
...
`else
  ...
  // reg IS_EN_A_INVERTED_BIN;
  // reg IS_EN_B_INVERTED_BIN;
  // reg IS_RDB_WR_A_INVERTED_BIN;
  // reg IS_RDB_WR_B_INVERTED_BIN;
  // reg IS_RST_A_INVERTED_BIN;
  // reg IS_RST_B_INVERTED_BIN;
  // reg OREG_A_BIN;
  // reg OREG_B_BIN;
  // reg OREG_ECC_A_BIN;
  // reg OREG_ECC_B_BIN;
  ...
  // reg RST_MODE_A_BIN;
  // reg RST_MODE_B_BIN;
  // reg [10:0] SELF_ADDR_A_BIN;
  // reg [10:0] SELF_ADDR_B_BIN;
  // reg [10:0] SELF_MASK_A_BIN;
  // reg [10:0] SELF_MASK_B_BIN;
...
//  wire CAS_OUT_DBITERR_A_out;
//  wire CAS_OUT_DBITERR_B_out;
  reg CAS_OUT_EN_A_out;
  reg CAS_OUT_EN_B_out;
//  wire CAS_OUT_RDACCESS_A_out;
//  wire CAS_OUT_RDACCESS_B_out;
  reg CAS_OUT_RDB_WR_A_out;
  reg CAS_OUT_RDB_WR_B_out;
//  wire CAS_OUT_SBITERR_A_out;
//  wire CAS_OUT_SBITERR_B_out;
  reg DBITERR_A_out;
  reg DBITERR_B_out;
  reg RDACCESS_A_out;
  reg RDACCESS_B_out;
...
//  wire [71:0] CAS_OUT_DOUT_A_out;
//  wire [71:0] CAS_OUT_DOUT_B_out;
  reg [71:0] DOUT_A_out;
  reg [71:0] DOUT_B_out;
  ...
  assign CAS_IN_ADDR_A_in[0]  =  CAS_IN_ADDR_A[0]; // rv 0
  assign CAS_IN_ADDR_A_in[10] =  CAS_IN_ADDR_A[10]; // rv 0
  assign CAS_IN_ADDR_A_in[11] =  CAS_IN_ADDR_A[11]; // rv 0
  assign CAS_IN_ADDR_A_in[12] =  CAS_IN_ADDR_A[12]; // rv 0
  assign CAS_IN_ADDR_A_in[13] =  CAS_IN_ADDR_A[13]; // rv 0
  assign CAS_IN_ADDR_A_in[14] =  CAS_IN_ADDR_A[14]; // rv 0
  assign CAS_IN_ADDR_A_in[15] =  CAS_IN_ADDR_A[15]; // rv 0
  assign CAS_IN_ADDR_A_in[16] =  CAS_IN_ADDR_A[16]; // rv 0
  assign CAS_IN_ADDR_A_in[17] =  CAS_IN_ADDR_A[17]; // rv 0
  assign CAS_IN_ADDR_A_in[18] =  CAS_IN_ADDR_A[18]; // rv 0
  assign CAS_IN_ADDR_A_in[19] =  CAS_IN_ADDR_A[19]; // rv 0
  assign CAS_IN_ADDR_A_in[1]  =  CAS_IN_ADDR_A[1]; // rv 0
  assign CAS_IN_ADDR_A_in[20] =  CAS_IN_ADDR_A[20]; // rv 0
  assign CAS_IN_ADDR_A_in[21] =  CAS_IN_ADDR_A[21]; // rv 0
  assign CAS_IN_ADDR_A_in[22] =  CAS_IN_ADDR_A[22]; // rv 0
  assign CAS_IN_ADDR_A_in[2]  =  CAS_IN_ADDR_A[2]; // rv 0
  assign CAS_IN_ADDR_A_in[3]  =  CAS_IN_ADDR_A[3]; // rv 0
  assign CAS_IN_ADDR_A_in[4]  =  CAS_IN_ADDR_A[4]; // rv 0
  assign CAS_IN_ADDR_A_in[5]  =  CAS_IN_ADDR_A[5]; // rv 0
  assign CAS_IN_ADDR_A_in[6]  =  CAS_IN_ADDR_A[6]; // rv 0
  assign CAS_IN_ADDR_A_in[7]  =  CAS_IN_ADDR_A[7]; // rv 0
  assign CAS_IN_ADDR_A_in[8]  =  CAS_IN_ADDR_A[8]; // rv 0
  assign CAS_IN_ADDR_A_in[9]  =  CAS_IN_ADDR_A[9]; // rv 0
  assign CAS_IN_ADDR_B_in[0]  =  CAS_IN_ADDR_B[0]; // rv 0
  assign CAS_IN_ADDR_B_in[10] =  CAS_IN_ADDR_B[10]; // rv 0
  assign CAS_IN_ADDR_B_in[11] =  CAS_IN_ADDR_B[11]; // rv 0
  assign CAS_IN_ADDR_B_in[12] =  CAS_IN_ADDR_B[12]; // rv 0
  assign CAS_IN_ADDR_B_in[13] =  CAS_IN_ADDR_B[13]; // rv 0
  assign CAS_IN_ADDR_B_in[14] =  CAS_IN_ADDR_B[14]; // rv 0
  assign CAS_IN_ADDR_B_in[15] =  CAS_IN_ADDR_B[15]; // rv 0
  assign CAS_IN_ADDR_B_in[16] =  CAS_IN_ADDR_B[16]; // rv 0
  assign CAS_IN_ADDR_B_in[17] =  CAS_IN_ADDR_B[17]; // rv 0
  assign CAS_IN_ADDR_B_in[18] =  CAS_IN_ADDR_B[18]; // rv 0
  assign CAS_IN_ADDR_B_in[19] =  CAS_IN_ADDR_B[19]; // rv 0
  assign CAS_IN_ADDR_B_in[1]  =  CAS_IN_ADDR_B[1]; // rv 0
  assign CAS_IN_ADDR_B_in[20] =  CAS_IN_ADDR_B[20]; // rv 0
  assign CAS_IN_ADDR_B_in[21] =  CAS_IN_ADDR_B[21]; // rv 0
  assign CAS_IN_ADDR_B_in[22] =  CAS_IN_ADDR_B[22]; // rv 0
  assign CAS_IN_ADDR_B_in[2]  =  CAS_IN_ADDR_B[2]; // rv 0
  assign CAS_IN_ADDR_B_in[3]  =  CAS_IN_ADDR_B[3]; // rv 0
  assign CAS_IN_ADDR_B_in[4]  =  CAS_IN_ADDR_B[4]; // rv 0
  assign CAS_IN_ADDR_B_in[5]  =  CAS_IN_ADDR_B[5]; // rv 0
  assign CAS_IN_ADDR_B_in[6]  =  CAS_IN_ADDR_B[6]; // rv 0
  assign CAS_IN_ADDR_B_in[7]  =  CAS_IN_ADDR_B[7]; // rv 0
  assign CAS_IN_ADDR_B_in[8]  =  CAS_IN_ADDR_B[8]; // rv 0
  assign CAS_IN_ADDR_B_in[9]  =  CAS_IN_ADDR_B[9]; // rv 0
  assign CAS_IN_BWE_A_in[0]   =  CAS_IN_BWE_A[0]; // rv 0
  assign CAS_IN_BWE_A_in[1]   =  CAS_IN_BWE_A[1]; // rv 0
  assign CAS_IN_BWE_A_in[2]   =  CAS_IN_BWE_A[2]; // rv 0
  assign CAS_IN_BWE_A_in[3]   =  CAS_IN_BWE_A[3]; // rv 0
  assign CAS_IN_BWE_A_in[4]   =  CAS_IN_BWE_A[4]; // rv 0
  assign CAS_IN_BWE_A_in[5]   =  CAS_IN_BWE_A[5]; // rv 0
  assign CAS_IN_BWE_A_in[6]   =  CAS_IN_BWE_A[6]; // rv 0
  assign CAS_IN_BWE_A_in[7]   =  CAS_IN_BWE_A[7]; // rv 0
  assign CAS_IN_BWE_A_in[8]   =  CAS_IN_BWE_A[8]; // rv 0
  assign CAS_IN_BWE_B_in[0]   =  CAS_IN_BWE_B[0]; // rv 0
  assign CAS_IN_BWE_B_in[1]   =  CAS_IN_BWE_B[1]; // rv 0
  assign CAS_IN_BWE_B_in[2]   =  CAS_IN_BWE_B[2]; // rv 0
  assign CAS_IN_BWE_B_in[3]   =  CAS_IN_BWE_B[3]; // rv 0
  assign CAS_IN_BWE_B_in[4]   =  CAS_IN_BWE_B[4]; // rv 0
  assign CAS_IN_BWE_B_in[5]   =  CAS_IN_BWE_B[5]; // rv 0
  assign CAS_IN_BWE_B_in[6]   =  CAS_IN_BWE_B[6]; // rv 0
  assign CAS_IN_BWE_B_in[7]   =  CAS_IN_BWE_B[7]; // rv 0
  assign CAS_IN_BWE_B_in[8]   =  CAS_IN_BWE_B[8]; // rv 0
  assign CAS_IN_DBITERR_A_in  =  CAS_IN_DBITERR_A; // rv 0
  assign CAS_IN_DBITERR_B_in  =  CAS_IN_DBITERR_B; // rv 0
  assign CAS_IN_DIN_A_in[0]   =  CAS_IN_DIN_A[0]; // rv 0
  assign CAS_IN_DIN_A_in[10]  =  CAS_IN_DIN_A[10]; // rv 0
  assign CAS_IN_DIN_A_in[11]  =  CAS_IN_DIN_A[11]; // rv 0
  assign CAS_IN_DIN_A_in[12]  =  CAS_IN_DIN_A[12]; // rv 0
  assign CAS_IN_DIN_A_in[13]  =  CAS_IN_DIN_A[13]; // rv 0
  assign CAS_IN_DIN_A_in[14]  =  CAS_IN_DIN_A[14]; // rv 0
  assign CAS_IN_DIN_A_in[15]  =  CAS_IN_DIN_A[15]; // rv 0
  assign CAS_IN_DIN_A_in[16]  =  CAS_IN_DIN_A[16]; // rv 0
  assign CAS_IN_DIN_A_in[17]  =  CAS_IN_DIN_A[17]; // rv 0
  assign CAS_IN_DIN_A_in[18]  =  CAS_IN_DIN_A[18]; // rv 0
  assign CAS_IN_DIN_A_in[19]  =  CAS_IN_DIN_A[19]; // rv 0
  assign CAS_IN_DIN_A_in[1]   =  CAS_IN_DIN_A[1]; // rv 0
  assign CAS_IN_DIN_A_in[20]  =  CAS_IN_DIN_A[20]; // rv 0
  assign CAS_IN_DIN_A_in[21]  =  CAS_IN_DIN_A[21]; // rv 0
  assign CAS_IN_DIN_A_in[22]  =  CAS_IN_DIN_A[22]; // rv 0
  assign CAS_IN_DIN_A_in[23]  =  CAS_IN_DIN_A[23]; // rv 0
  assign CAS_IN_DIN_A_in[24]  =  CAS_IN_DIN_A[24]; // rv 0
  assign CAS_IN_DIN_A_in[25]  =  CAS_IN_DIN_A[25]; // rv 0
  assign CAS_IN_DIN_A_in[26]  =  CAS_IN_DIN_A[26]; // rv 0
  assign CAS_IN_DIN_A_in[27]  =  CAS_IN_DIN_A[27]; // rv 0
  assign CAS_IN_DIN_A_in[28]  =  CAS_IN_DIN_A[28]; // rv 0
  assign CAS_IN_DIN_A_in[29]  =  CAS_IN_DIN_A[29]; // rv 0
  assign CAS_IN_DIN_A_in[2]   =  CAS_IN_DIN_A[2]; // rv 0
  assign CAS_IN_DIN_A_in[30]  =  CAS_IN_DIN_A[30]; // rv 0
  assign CAS_IN_DIN_A_in[31]  =  CAS_IN_DIN_A[31]; // rv 0
  assign CAS_IN_DIN_A_in[32]  =  CAS_IN_DIN_A[32]; // rv 0
  assign CAS_IN_DIN_A_in[33]  =  CAS_IN_DIN_A[33]; // rv 0
  assign CAS_IN_DIN_A_in[34]  =  CAS_IN_DIN_A[34]; // rv 0
  assign CAS_IN_DIN_A_in[35]  =  CAS_IN_DIN_A[35]; // rv 0
  assign CAS_IN_DIN_A_in[36]  =  CAS_IN_DIN_A[36]; // rv 0
  assign CAS_IN_DIN_A_in[37]  =  CAS_IN_DIN_A[37]; // rv 0
  assign CAS_IN_DIN_A_in[38]  =  CAS_IN_DIN_A[38]; // rv 0
  assign CAS_IN_DIN_A_in[39]  =  CAS_IN_DIN_A[39]; // rv 0
  assign CAS_IN_DIN_A_in[3]   =  CAS_IN_DIN_A[3]; // rv 0
  assign CAS_IN_DIN_A_in[40]  =  CAS_IN_DIN_A[40]; // rv 0
  assign CAS_IN_DIN_A_in[41]  =  CAS_IN_DIN_A[41]; // rv 0
  assign CAS_IN_DIN_A_in[42]  =  CAS_IN_DIN_A[42]; // rv 0
  assign CAS_IN_DIN_A_in[43]  =  CAS_IN_DIN_A[43]; // rv 0
  assign CAS_IN_DIN_A_in[44]  =  CAS_IN_DIN_A[44]; // rv 0
  assign CAS_IN_DIN_A_in[45]  =  CAS_IN_DIN_A[45]; // rv 0
  assign CAS_IN_DIN_A_in[46]  =  CAS_IN_DIN_A[46]; // rv 0
  assign CAS_IN_DIN_A_in[47]  =  CAS_IN_DIN_A[47]; // rv 0
  assign CAS_IN_DIN_A_in[48]  =  CAS_IN_DIN_A[48]; // rv 0
  assign CAS_IN_DIN_A_in[49]  =  CAS_IN_DIN_A[49]; // rv 0
  assign CAS_IN_DIN_A_in[4]   =  CAS_IN_DIN_A[4]; // rv 0
  assign CAS_IN_DIN_A_in[50]  =  CAS_IN_DIN_A[50]; // rv 0
  assign CAS_IN_DIN_A_in[51]  =  CAS_IN_DIN_A[51]; // rv 0
  assign CAS_IN_DIN_A_in[52]  =  CAS_IN_DIN_A[52]; // rv 0
  assign CAS_IN_DIN_A_in[53]  =  CAS_IN_DIN_A[53]; // rv 0
  assign CAS_IN_DIN_A_in[54]  =  CAS_IN_DIN_A[54]; // rv 0
  assign CAS_IN_DIN_A_in[55]  =  CAS_IN_DIN_A[55]; // rv 0
  assign CAS_IN_DIN_A_in[56]  =  CAS_IN_DIN_A[56]; // rv 0
  assign CAS_IN_DIN_A_in[57]  =  CAS_IN_DIN_A[57]; // rv 0
  assign CAS_IN_DIN_A_in[58]  =  CAS_IN_DIN_A[58]; // rv 0
  assign CAS_IN_DIN_A_in[59]  =  CAS_IN_DIN_A[59]; // rv 0
  assign CAS_IN_DIN_A_in[5]   =  CAS_IN_DIN_A[5]; // rv 0
  assign CAS_IN_DIN_A_in[60]  =  CAS_IN_DIN_A[60]; // rv 0
  assign CAS_IN_DIN_A_in[61]  =  CAS_IN_DIN_A[61]; // rv 0
  assign CAS_IN_DIN_A_in[62]  =  CAS_IN_DIN_A[62]; // rv 0
  assign CAS_IN_DIN_A_in[63]  =  CAS_IN_DIN_A[63]; // rv 0
  assign CAS_IN_DIN_A_in[64]  =  CAS_IN_DIN_A[64]; // rv 0
  assign CAS_IN_DIN_A_in[65]  =  CAS_IN_DIN_A[65]; // rv 0
  assign CAS_IN_DIN_A_in[66]  =  CAS_IN_DIN_A[66]; // rv 0
  assign CAS_IN_DIN_A_in[67]  =  CAS_IN_DIN_A[67]; // rv 0
  assign CAS_IN_DIN_A_in[68]  =  CAS_IN_DIN_A[68]; // rv 0
  assign CAS_IN_DIN_A_in[69]  =  CAS_IN_DIN_A[69]; // rv 0
  assign CAS_IN_DIN_A_in[6]   =  CAS_IN_DIN_A[6]; // rv 0
  assign CAS_IN_DIN_A_in[70]  =  CAS_IN_DIN_A[70]; // rv 0
  assign CAS_IN_DIN_A_in[71]  =  CAS_IN_DIN_A[71]; // rv 0
  assign CAS_IN_DIN_A_in[7]   =  CAS_IN_DIN_A[7]; // rv 0
  assign CAS_IN_DIN_A_in[8]   =  CAS_IN_DIN_A[8]; // rv 0
  assign CAS_IN_DIN_A_in[9]   =  CAS_IN_DIN_A[9]; // rv 0
  assign CAS_IN_DIN_B_in[0]   =  CAS_IN_DIN_B[0]; // rv 0
  assign CAS_IN_DIN_B_in[10]  =  CAS_IN_DIN_B[10]; // rv 0
  assign CAS_IN_DIN_B_in[11]  =  CAS_IN_DIN_B[11]; // rv 0
  assign CAS_IN_DIN_B_in[12]  =  CAS_IN_DIN_B[12]; // rv 0
  assign CAS_IN_DIN_B_in[13]  =  CAS_IN_DIN_B[13]; // rv 0
  assign CAS_IN_DIN_B_in[14]  =  CAS_IN_DIN_B[14]; // rv 0
  assign CAS_IN_DIN_B_in[15]  =  CAS_IN_DIN_B[15]; // rv 0
  assign CAS_IN_DIN_B_in[16]  =  CAS_IN_DIN_B[16]; // rv 0
  assign CAS_IN_DIN_B_in[17]  =  CAS_IN_DIN_B[17]; // rv 0
  assign CAS_IN_DIN_B_in[18]  =  CAS_IN_DIN_B[18]; // rv 0
  assign CAS_IN_DIN_B_in[19]  =  CAS_IN_DIN_B[19]; // rv 0
  assign CAS_IN_DIN_B_in[1]   =  CAS_IN_DIN_B[1]; // rv 0
  assign CAS_IN_DIN_B_in[20]  =  CAS_IN_DIN_B[20]; // rv 0
  assign CAS_IN_DIN_B_in[21]  =  CAS_IN_DIN_B[21]; // rv 0
  assign CAS_IN_DIN_B_in[22]  =  CAS_IN_DIN_B[22]; // rv 0
  assign CAS_IN_DIN_B_in[23]  =  CAS_IN_DIN_B[23]; // rv 0
  assign CAS_IN_DIN_B_in[24]  =  CAS_IN_DIN_B[24]; // rv 0
  assign CAS_IN_DIN_B_in[25]  =  CAS_IN_DIN_B[25]; // rv 0
  assign CAS_IN_DIN_B_in[26]  =  CAS_IN_DIN_B[26]; // rv 0
  assign CAS_IN_DIN_B_in[27]  =  CAS_IN_DIN_B[27]; // rv 0
  assign CAS_IN_DIN_B_in[28]  =  CAS_IN_DIN_B[28]; // rv 0
  assign CAS_IN_DIN_B_in[29]  =  CAS_IN_DIN_B[29]; // rv 0
  assign CAS_IN_DIN_B_in[2]   =  CAS_IN_DIN_B[2]; // rv 0
  assign CAS_IN_DIN_B_in[30]  =  CAS_IN_DIN_B[30]; // rv 0
  assign CAS_IN_DIN_B_in[31]  =  CAS_IN_DIN_B[31]; // rv 0
  assign CAS_IN_DIN_B_in[32]  =  CAS_IN_DIN_B[32]; // rv 0
  assign CAS_IN_DIN_B_in[33]  =  CAS_IN_DIN_B[33]; // rv 0
  assign CAS_IN_DIN_B_in[34]  =  CAS_IN_DIN_B[34]; // rv 0
  assign CAS_IN_DIN_B_in[35]  =  CAS_IN_DIN_B[35]; // rv 0
  assign CAS_IN_DIN_B_in[36]  =  CAS_IN_DIN_B[36]; // rv 0
  assign CAS_IN_DIN_B_in[37]  =  CAS_IN_DIN_B[37]; // rv 0
  assign CAS_IN_DIN_B_in[38]  =  CAS_IN_DIN_B[38]; // rv 0
  assign CAS_IN_DIN_B_in[39]  =  CAS_IN_DIN_B[39]; // rv 0
  assign CAS_IN_DIN_B_in[3]   =  CAS_IN_DIN_B[3]; // rv 0
  assign CAS_IN_DIN_B_in[40]  =  CAS_IN_DIN_B[40]; // rv 0
  assign CAS_IN_DIN_B_in[41]  =  CAS_IN_DIN_B[41]; // rv 0
  assign CAS_IN_DIN_B_in[42]  =  CAS_IN_DIN_B[42]; // rv 0
  assign CAS_IN_DIN_B_in[43]  =  CAS_IN_DIN_B[43]; // rv 0
  assign CAS_IN_DIN_B_in[44]  =  CAS_IN_DIN_B[44]; // rv 0
  assign CAS_IN_DIN_B_in[45]  =  CAS_IN_DIN_B[45]; // rv 0
  assign CAS_IN_DIN_B_in[46]  =  CAS_IN_DIN_B[46]; // rv 0
  assign CAS_IN_DIN_B_in[47]  =  CAS_IN_DIN_B[47]; // rv 0
  assign CAS_IN_DIN_B_in[48]  =  CAS_IN_DIN_B[48]; // rv 0
  assign CAS_IN_DIN_B_in[49]  =  CAS_IN_DIN_B[49]; // rv 0
  assign CAS_IN_DIN_B_in[4]   =  CAS_IN_DIN_B[4]; // rv 0
  assign CAS_IN_DIN_B_in[50]  =  CAS_IN_DIN_B[50]; // rv 0
  assign CAS_IN_DIN_B_in[51]  =  CAS_IN_DIN_B[51]; // rv 0
  assign CAS_IN_DIN_B_in[52]  =  CAS_IN_DIN_B[52]; // rv 0
  assign CAS_IN_DIN_B_in[53]  =  CAS_IN_DIN_B[53]; // rv 0
  assign CAS_IN_DIN_B_in[54]  =  CAS_IN_DIN_B[54]; // rv 0
  assign CAS_IN_DIN_B_in[55]  =  CAS_IN_DIN_B[55]; // rv 0
  assign CAS_IN_DIN_B_in[56]  =  CAS_IN_DIN_B[56]; // rv 0
  assign CAS_IN_DIN_B_in[57]  =  CAS_IN_DIN_B[57]; // rv 0
  assign CAS_IN_DIN_B_in[58]  =  CAS_IN_DIN_B[58]; // rv 0
  assign CAS_IN_DIN_B_in[59]  =  CAS_IN_DIN_B[59]; // rv 0
  assign CAS_IN_DIN_B_in[5]   =  CAS_IN_DIN_B[5]; // rv 0
  assign CAS_IN_DIN_B_in[60]  =  CAS_IN_DIN_B[60]; // rv 0
  assign CAS_IN_DIN_B_in[61]  =  CAS_IN_DIN_B[61]; // rv 0
  assign CAS_IN_DIN_B_in[62]  =  CAS_IN_DIN_B[62]; // rv 0
  assign CAS_IN_DIN_B_in[63]  =  CAS_IN_DIN_B[63]; // rv 0
  assign CAS_IN_DIN_B_in[64]  =  CAS_IN_DIN_B[64]; // rv 0
  assign CAS_IN_DIN_B_in[65]  =  CAS_IN_DIN_B[65]; // rv 0
  assign CAS_IN_DIN_B_in[66]  =  CAS_IN_DIN_B[66]; // rv 0
  assign CAS_IN_DIN_B_in[67]  =  CAS_IN_DIN_B[67]; // rv 0
  assign CAS_IN_DIN_B_in[68]  =  CAS_IN_DIN_B[68]; // rv 0
  assign CAS_IN_DIN_B_in[69]  =  CAS_IN_DIN_B[69]; // rv 0
  assign CAS_IN_DIN_B_in[6]   =  CAS_IN_DIN_B[6]; // rv 0
  assign CAS_IN_DIN_B_in[70]  =  CAS_IN_DIN_B[70]; // rv 0
  assign CAS_IN_DIN_B_in[71]  =  CAS_IN_DIN_B[71]; // rv 0
  assign CAS_IN_DIN_B_in[7]   =  CAS_IN_DIN_B[7]; // rv 0
  assign CAS_IN_DIN_B_in[8]   =  CAS_IN_DIN_B[8]; // rv 0
  assign CAS_IN_DIN_B_in[9]   =  CAS_IN_DIN_B[9]; // rv 0
  assign CAS_IN_DOUT_A_in[0]  =  CAS_IN_DOUT_A[0]; // rv 0
  assign CAS_IN_DOUT_A_in[10] =  CAS_IN_DOUT_A[10]; // rv 0
  assign CAS_IN_DOUT_A_in[11] =  CAS_IN_DOUT_A[11]; // rv 0
  assign CAS_IN_DOUT_A_in[12] =  CAS_IN_DOUT_A[12]; // rv 0
  assign CAS_IN_DOUT_A_in[13] =  CAS_IN_DOUT_A[13]; // rv 0
  assign CAS_IN_DOUT_A_in[14] =  CAS_IN_DOUT_A[14]; // rv 0
  assign CAS_IN_DOUT_A_in[15] =  CAS_IN_DOUT_A[15]; // rv 0
  assign CAS_IN_DOUT_A_in[16] =  CAS_IN_DOUT_A[16]; // rv 0
  assign CAS_IN_DOUT_A_in[17] =  CAS_IN_DOUT_A[17]; // rv 0
  assign CAS_IN_DOUT_A_in[18] =  CAS_IN_DOUT_A[18]; // rv 0
  assign CAS_IN_DOUT_A_in[19] =  CAS_IN_DOUT_A[19]; // rv 0
  assign CAS_IN_DOUT_A_in[1]  =  CAS_IN_DOUT_A[1]; // rv 0
  assign CAS_IN_DOUT_A_in[20] =  CAS_IN_DOUT_A[20]; // rv 0
  assign CAS_IN_DOUT_A_in[21] =  CAS_IN_DOUT_A[21]; // rv 0
  assign CAS_IN_DOUT_A_in[22] =  CAS_IN_DOUT_A[22]; // rv 0
  assign CAS_IN_DOUT_A_in[23] =  CAS_IN_DOUT_A[23]; // rv 0
  assign CAS_IN_DOUT_A_in[24] =  CAS_IN_DOUT_A[24]; // rv 0
  assign CAS_IN_DOUT_A_in[25] =  CAS_IN_DOUT_A[25]; // rv 0
  assign CAS_IN_DOUT_A_in[26] =  CAS_IN_DOUT_A[26]; // rv 0
  assign CAS_IN_DOUT_A_in[27] =  CAS_IN_DOUT_A[27]; // rv 0
  assign CAS_IN_DOUT_A_in[28] =  CAS_IN_DOUT_A[28]; // rv 0
  assign CAS_IN_DOUT_A_in[29] =  CAS_IN_DOUT_A[29]; // rv 0
  assign CAS_IN_DOUT_A_in[2]  =  CAS_IN_DOUT_A[2]; // rv 0
  assign CAS_IN_DOUT_A_in[30] =  CAS_IN_DOUT_A[30]; // rv 0
  assign CAS_IN_DOUT_A_in[31] =  CAS_IN_DOUT_A[31]; // rv 0
  assign CAS_IN_DOUT_A_in[32] =  CAS_IN_DOUT_A[32]; // rv 0
  assign CAS_IN_DOUT_A_in[33] =  CAS_IN_DOUT_A[33]; // rv 0
  assign CAS_IN_DOUT_A_in[34] =  CAS_IN_DOUT_A[34]; // rv 0
  assign CAS_IN_DOUT_A_in[35] =  CAS_IN_DOUT_A[35]; // rv 0
  assign CAS_IN_DOUT_A_in[36] =  CAS_IN_DOUT_A[36]; // rv 0
  assign CAS_IN_DOUT_A_in[37] =  CAS_IN_DOUT_A[37]; // rv 0
  assign CAS_IN_DOUT_A_in[38] =  CAS_IN_DOUT_A[38]; // rv 0
  assign CAS_IN_DOUT_A_in[39] =  CAS_IN_DOUT_A[39]; // rv 0
  assign CAS_IN_DOUT_A_in[3]  =  CAS_IN_DOUT_A[3]; // rv 0
  assign CAS_IN_DOUT_A_in[40] =  CAS_IN_DOUT_A[40]; // rv 0
  assign CAS_IN_DOUT_A_in[41] =  CAS_IN_DOUT_A[41]; // rv 0
  assign CAS_IN_DOUT_A_in[42] =  CAS_IN_DOUT_A[42]; // rv 0
  assign CAS_IN_DOUT_A_in[43] =  CAS_IN_DOUT_A[43]; // rv 0
  assign CAS_IN_DOUT_A_in[44] =  CAS_IN_DOUT_A[44]; // rv 0
  assign CAS_IN_DOUT_A_in[45] =  CAS_IN_DOUT_A[45]; // rv 0
  assign CAS_IN_DOUT_A_in[46] =  CAS_IN_DOUT_A[46]; // rv 0
  assign CAS_IN_DOUT_A_in[47] =  CAS_IN_DOUT_A[47]; // rv 0
  assign CAS_IN_DOUT_A_in[48] =  CAS_IN_DOUT_A[48]; // rv 0
  assign CAS_IN_DOUT_A_in[49] =  CAS_IN_DOUT_A[49]; // rv 0
  assign CAS_IN_DOUT_A_in[4]  =  CAS_IN_DOUT_A[4]; // rv 0
  assign CAS_IN_DOUT_A_in[50] =  CAS_IN_DOUT_A[50]; // rv 0
  assign CAS_IN_DOUT_A_in[51] =  CAS_IN_DOUT_A[51]; // rv 0
  assign CAS_IN_DOUT_A_in[52] =  CAS_IN_DOUT_A[52]; // rv 0
  assign CAS_IN_DOUT_A_in[53] =  CAS_IN_DOUT_A[53]; // rv 0
  assign CAS_IN_DOUT_A_in[54] =  CAS_IN_DOUT_A[54]; // rv 0
  assign CAS_IN_DOUT_A_in[55] =  CAS_IN_DOUT_A[55]; // rv 0
  assign CAS_IN_DOUT_A_in[56] =  CAS_IN_DOUT_A[56]; // rv 0
  assign CAS_IN_DOUT_A_in[57] =  CAS_IN_DOUT_A[57]; // rv 0
  assign CAS_IN_DOUT_A_in[58] =  CAS_IN_DOUT_A[58]; // rv 0
  assign CAS_IN_DOUT_A_in[59] =  CAS_IN_DOUT_A[59]; // rv 0
  assign CAS_IN_DOUT_A_in[5]  =  CAS_IN_DOUT_A[5]; // rv 0
  assign CAS_IN_DOUT_A_in[60] =  CAS_IN_DOUT_A[60]; // rv 0
  assign CAS_IN_DOUT_A_in[61] =  CAS_IN_DOUT_A[61]; // rv 0
  assign CAS_IN_DOUT_A_in[62] =  CAS_IN_DOUT_A[62]; // rv 0
  assign CAS_IN_DOUT_A_in[63] =  CAS_IN_DOUT_A[63]; // rv 0
  assign CAS_IN_DOUT_A_in[64] =  CAS_IN_DOUT_A[64]; // rv 0
  assign CAS_IN_DOUT_A_in[65] =  CAS_IN_DOUT_A[65]; // rv 0
  assign CAS_IN_DOUT_A_in[66] =  CAS_IN_DOUT_A[66]; // rv 0
  assign CAS_IN_DOUT_A_in[67] =  CAS_IN_DOUT_A[67]; // rv 0
  assign CAS_IN_DOUT_A_in[68] =  CAS_IN_DOUT_A[68]; // rv 0
  assign CAS_IN_DOUT_A_in[69] =  CAS_IN_DOUT_A[69]; // rv 0
  assign CAS_IN_DOUT_A_in[6]  =  CAS_IN_DOUT_A[6]; // rv 0
  assign CAS_IN_DOUT_A_in[70] =  CAS_IN_DOUT_A[70]; // rv 0
  assign CAS_IN_DOUT_A_in[71] =  CAS_IN_DOUT_A[71]; // rv 0
  assign CAS_IN_DOUT_A_in[7]  =  CAS_IN_DOUT_A[7]; // rv 0
  assign CAS_IN_DOUT_A_in[8]  =  CAS_IN_DOUT_A[8]; // rv 0
  assign CAS_IN_DOUT_A_in[9]  =  CAS_IN_DOUT_A[9]; // rv 0
  assign CAS_IN_DOUT_B_in[0]  =  CAS_IN_DOUT_B[0]; // rv 0
  assign CAS_IN_DOUT_B_in[10] =  CAS_IN_DOUT_B[10]; // rv 0
  assign CAS_IN_DOUT_B_in[11] =  CAS_IN_DOUT_B[11]; // rv 0
  assign CAS_IN_DOUT_B_in[12] =  CAS_IN_DOUT_B[12]; // rv 0
  assign CAS_IN_DOUT_B_in[13] =  CAS_IN_DOUT_B[13]; // rv 0
  assign CAS_IN_DOUT_B_in[14] =  CAS_IN_DOUT_B[14]; // rv 0
  assign CAS_IN_DOUT_B_in[15] =  CAS_IN_DOUT_B[15]; // rv 0
  assign CAS_IN_DOUT_B_in[16] =  CAS_IN_DOUT_B[16]; // rv 0
  assign CAS_IN_DOUT_B_in[17] =  CAS_IN_DOUT_B[17]; // rv 0
  assign CAS_IN_DOUT_B_in[18] =  CAS_IN_DOUT_B[18]; // rv 0
  assign CAS_IN_DOUT_B_in[19] =  CAS_IN_DOUT_B[19]; // rv 0
  assign CAS_IN_DOUT_B_in[1]  =  CAS_IN_DOUT_B[1]; // rv 0
  assign CAS_IN_DOUT_B_in[20] =  CAS_IN_DOUT_B[20]; // rv 0
  assign CAS_IN_DOUT_B_in[21] =  CAS_IN_DOUT_B[21]; // rv 0
  assign CAS_IN_DOUT_B_in[22] =  CAS_IN_DOUT_B[22]; // rv 0
  assign CAS_IN_DOUT_B_in[23] =  CAS_IN_DOUT_B[23]; // rv 0
  assign CAS_IN_DOUT_B_in[24] =  CAS_IN_DOUT_B[24]; // rv 0
  assign CAS_IN_DOUT_B_in[25] =  CAS_IN_DOUT_B[25]; // rv 0
  assign CAS_IN_DOUT_B_in[26] =  CAS_IN_DOUT_B[26]; // rv 0
  assign CAS_IN_DOUT_B_in[27] =  CAS_IN_DOUT_B[27]; // rv 0
  assign CAS_IN_DOUT_B_in[28] =  CAS_IN_DOUT_B[28]; // rv 0
  assign CAS_IN_DOUT_B_in[29] =  CAS_IN_DOUT_B[29]; // rv 0
  assign CAS_IN_DOUT_B_in[2]  =  CAS_IN_DOUT_B[2]; // rv 0
  assign CAS_IN_DOUT_B_in[30] =  CAS_IN_DOUT_B[30]; // rv 0
  assign CAS_IN_DOUT_B_in[31] =  CAS_IN_DOUT_B[31]; // rv 0
  assign CAS_IN_DOUT_B_in[32] =  CAS_IN_DOUT_B[32]; // rv 0
  assign CAS_IN_DOUT_B_in[33] =  CAS_IN_DOUT_B[33]; // rv 0
  assign CAS_IN_DOUT_B_in[34] =  CAS_IN_DOUT_B[34]; // rv 0
  assign CAS_IN_DOUT_B_in[35] =  CAS_IN_DOUT_B[35]; // rv 0
  assign CAS_IN_DOUT_B_in[36] =  CAS_IN_DOUT_B[36]; // rv 0
  assign CAS_IN_DOUT_B_in[37] =  CAS_IN_DOUT_B[37]; // rv 0
  assign CAS_IN_DOUT_B_in[38] =  CAS_IN_DOUT_B[38]; // rv 0
  assign CAS_IN_DOUT_B_in[39] =  CAS_IN_DOUT_B[39]; // rv 0
  assign CAS_IN_DOUT_B_in[3]  =  CAS_IN_DOUT_B[3]; // rv 0
  assign CAS_IN_DOUT_B_in[40] =  CAS_IN_DOUT_B[40]; // rv 0
  assign CAS_IN_DOUT_B_in[41] =  CAS_IN_DOUT_B[41]; // rv 0
  assign CAS_IN_DOUT_B_in[42] =  CAS_IN_DOUT_B[42]; // rv 0
  assign CAS_IN_DOUT_B_in[43] =  CAS_IN_DOUT_B[43]; // rv 0
  assign CAS_IN_DOUT_B_in[44] =  CAS_IN_DOUT_B[44]; // rv 0
  assign CAS_IN_DOUT_B_in[45] =  CAS_IN_DOUT_B[45]; // rv 0
  assign CAS_IN_DOUT_B_in[46] =  CAS_IN_DOUT_B[46]; // rv 0
  assign CAS_IN_DOUT_B_in[47] =  CAS_IN_DOUT_B[47]; // rv 0
  assign CAS_IN_DOUT_B_in[48] =  CAS_IN_DOUT_B[48]; // rv 0
  assign CAS_IN_DOUT_B_in[49] =  CAS_IN_DOUT_B[49]; // rv 0
  assign CAS_IN_DOUT_B_in[4]  =  CAS_IN_DOUT_B[4]; // rv 0
  assign CAS_IN_DOUT_B_in[50] =  CAS_IN_DOUT_B[50]; // rv 0
  assign CAS_IN_DOUT_B_in[51] =  CAS_IN_DOUT_B[51]; // rv 0
  assign CAS_IN_DOUT_B_in[52] =  CAS_IN_DOUT_B[52]; // rv 0
  assign CAS_IN_DOUT_B_in[53] =  CAS_IN_DOUT_B[53]; // rv 0
  assign CAS_IN_DOUT_B_in[54] =  CAS_IN_DOUT_B[54]; // rv 0
  assign CAS_IN_DOUT_B_in[55] =  CAS_IN_DOUT_B[55]; // rv 0
  assign CAS_IN_DOUT_B_in[56] =  CAS_IN_DOUT_B[56]; // rv 0
  assign CAS_IN_DOUT_B_in[57] =  CAS_IN_DOUT_B[57]; // rv 0
  assign CAS_IN_DOUT_B_in[58] =  CAS_IN_DOUT_B[58]; // rv 0
  assign CAS_IN_DOUT_B_in[59] =  CAS_IN_DOUT_B[59]; // rv 0
  assign CAS_IN_DOUT_B_in[5]  =  CAS_IN_DOUT_B[5]; // rv 0
  assign CAS_IN_DOUT_B_in[60] =  CAS_IN_DOUT_B[60]; // rv 0
  assign CAS_IN_DOUT_B_in[61] =  CAS_IN_DOUT_B[61]; // rv 0
  assign CAS_IN_DOUT_B_in[62] =  CAS_IN_DOUT_B[62]; // rv 0
  assign CAS_IN_DOUT_B_in[63] =  CAS_IN_DOUT_B[63]; // rv 0
  assign CAS_IN_DOUT_B_in[64] =  CAS_IN_DOUT_B[64]; // rv 0
  assign CAS_IN_DOUT_B_in[65] =  CAS_IN_DOUT_B[65]; // rv 0
  assign CAS_IN_DOUT_B_in[66] =  CAS_IN_DOUT_B[66]; // rv 0
  assign CAS_IN_DOUT_B_in[67] =  CAS_IN_DOUT_B[67]; // rv 0
  assign CAS_IN_DOUT_B_in[68] =  CAS_IN_DOUT_B[68]; // rv 0
  assign CAS_IN_DOUT_B_in[69] =  CAS_IN_DOUT_B[69]; // rv 0
  assign CAS_IN_DOUT_B_in[6]  =  CAS_IN_DOUT_B[6]; // rv 0
  assign CAS_IN_DOUT_B_in[70] =  CAS_IN_DOUT_B[70]; // rv 0
  assign CAS_IN_DOUT_B_in[71] =  CAS_IN_DOUT_B[71]; // rv 0
  assign CAS_IN_DOUT_B_in[7]  =  CAS_IN_DOUT_B[7]; // rv 0
  assign CAS_IN_DOUT_B_in[8]  =  CAS_IN_DOUT_B[8]; // rv 0
  assign CAS_IN_DOUT_B_in[9]  =  CAS_IN_DOUT_B[9]; // rv 0
  assign CAS_IN_EN_A_in       =  CAS_IN_EN_A; // rv 0
  assign CAS_IN_EN_B_in       =  CAS_IN_EN_B; // rv 0
  assign CAS_IN_RDACCESS_A_in =  CAS_IN_RDACCESS_A;
  assign CAS_IN_RDACCESS_B_in =  CAS_IN_RDACCESS_B;
  assign CAS_IN_RDB_WR_A_in   =  CAS_IN_RDB_WR_A; // rv 0
  assign CAS_IN_RDB_WR_B_in   =  CAS_IN_RDB_WR_B; // rv 0
  assign CAS_IN_SBITERR_A_in  =  CAS_IN_SBITERR_A; // rv 0
  assign CAS_IN_SBITERR_B_in  =  CAS_IN_SBITERR_B; // rv 0
  assign CLK_in               = (CLK ^ IS_CLK_INVERTED_BIN); // rv 0
  assign DIN_A_in             = DIN_A;
  assign DIN_B_in             = DIN_B;
  assign EN_A_in              = (EN_A ^ IS_EN_A_INVERTED_BIN); // rv 0
  assign EN_B_in              = (EN_B ^ IS_EN_B_INVERTED_BIN); // rv 0
  assign INJECT_DBITERR_A_in  = INJECT_DBITERR_A; // rv 0
  assign INJECT_DBITERR_B_in  = INJECT_DBITERR_B; // rv 0
  assign INJECT_SBITERR_A_in  = INJECT_SBITERR_A; // rv 0
  assign INJECT_SBITERR_B_in  = INJECT_SBITERR_B; // rv 0
  assign OREG_CE_A_in         = OREG_CE_A; // rv 1
  assign OREG_CE_B_in         = OREG_CE_B; // rv 1
  assign OREG_ECC_CE_A_in     = OREG_ECC_CE_A; // rv 1
  assign OREG_ECC_CE_B_in     = OREG_ECC_CE_B; // rv 1
  assign RDB_WR_A_in          = (RDB_WR_A ^ IS_RDB_WR_A_INVERTED_BIN); // rv 0
  assign RDB_WR_B_in          = (RDB_WR_B ^ IS_RDB_WR_B_INVERTED_BIN); // rv 0
  assign RST_A_in             = (RST_A ^ IS_RST_A_INVERTED_BIN); // rv 0
  assign RST_B_in             = (RST_B ^ IS_RST_B_INVERTED_BIN); // rv 0
  assign SHUTDOWN_in          = SHUTDOWN; // rv 0
  assign SLEEP_in             = SLEEP; // rv 0
...
`ifdef XIL_XECLIB
  localparam[3:0] AUTO_SLEEP_LATENCY_BIN = AUTO_SLEEP_LATENCY_REG;

  localparam[16:0] AVG_CONS_INACTIVE_CYCLES_BIN = AVG_CONS_INACTIVE_CYCLES_REG;

  localparam BWE_MODE_A_BIN =
  ...
  localparam[1:0] CASCADE_ORDER_A_BIN =
  ...
  localparam[1:0] CASCADE_ORDER_B_BIN =
  ...
  localparam EN_AUTO_SLEEP_MODE_BIN =
...
/*  always @ (trig_attr) begin
    #1;
    AUTO_SLEEP_LATENCY_BIN = AUTO_SLEEP_LATENCY_REG;

    AVG_CONS_INACTIVE_CYCLES_BIN = AVG_CONS_INACTIVE_CYCLES_REG;
    ...
    IS_EN_A_INVERTED_BIN = IS_EN_A_INVERTED_REG;

    IS_EN_B_INVERTED_BIN = IS_EN_B_INVERTED_REG;

    IS_RDB_WR_A_INVERTED_BIN = IS_RDB_WR_A_INVERTED_REG;
  
    IS_RDB_WR_B_INVERTED_BIN = IS_RDB_WR_B_INVERTED_REG;
  
    IS_RST_A_INVERTED_BIN = IS_RST_A_INVERTED_REG;

    IS_RST_B_INVERTED_BIN = IS_RST_B_INVERTED_REG;
    ...
    SELF_ADDR_A_BIN = SELF_ADDR_A_REG;

    SELF_ADDR_B_BIN = SELF_ADDR_B_REG;

    SELF_MASK_A_BIN = SELF_MASK_A_REG;

    SELF_MASK_B_BIN = SELF_MASK_B_REG;
...
`ifndef XIL_XECLIB
  ...
  #1;
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-115] IREG_PRE_A attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, IREG_PRE_A_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-116] IREG_PRE_B attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, IREG_PRE_B_REG);
      attr_err = 1'b1;
    end

    if ((attr_test == 1'b1) ||
        ((IS_CLK_INVERTED_REG !== 1'b0) && (IS_CLK_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-117] IS_CLK_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_CLK_INVERTED_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((IS_EN_A_INVERTED_REG !== 1'b0) && (IS_EN_A_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-118] IS_EN_A_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_EN_A_INVERTED_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((IS_EN_B_INVERTED_REG !== 1'b0) && (IS_EN_B_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-119] IS_EN_B_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_EN_B_INVERTED_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((IS_RDB_WR_A_INVERTED_REG !== 1'b0) && (IS_RDB_WR_A_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-120] IS_RDB_WR_A_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_RDB_WR_A_INVERTED_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((IS_RDB_WR_B_INVERTED_REG !== 1'b0) && (IS_RDB_WR_B_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-121] IS_RDB_WR_B_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_RDB_WR_B_INVERTED_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((IS_RST_A_INVERTED_REG !== 1'b0) && (IS_RST_A_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-122] IS_RST_A_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_RST_A_INVERTED_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((IS_RST_B_INVERTED_REG !== 1'b0) && (IS_RST_B_INVERTED_REG !== 1'b1))) begin
      $display("Error: [Unisim %s-123] IS_RST_B_INVERTED attribute is set to %b.  Legal values for this attribute are 1'b0 to 1'b1. Instance: %m", MODULE_NAME, IS_RST_B_INVERTED_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-124] OREG_A attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, OREG_A_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-125] OREG_B attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, OREG_B_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-128] OREG_ECC_A attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, OREG_ECC_A_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-129] OREG_ECC_B attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, OREG_ECC_B_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-130] REG_CAS_A attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, REG_CAS_A_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-131] REG_CAS_B attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, REG_CAS_B_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-132] RST_MODE_A attribute is set to %s.  Legal values for this attribute are SYNC or ASYNC. Instance: %m", MODULE_NAME, RST_MODE_A_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-133] RST_MODE_B attribute is set to %s.  Legal values for this attribute are SYNC or ASYNC. Instance: %m", MODULE_NAME, RST_MODE_B_REG);
      attr_err = 1'b1;
    end

    if ((attr_test == 1'b1) ||
        ((SELF_ADDR_A_REG < 11'h000) || (SELF_ADDR_A_REG > 11'h7FF))) begin
      $display("Error: [Unisim %s-134] SELF_ADDR_A attribute is set to %h.  Legal values for this attribute are 11'h000 to 11'h7FF. Instance: %m", MODULE_NAME, SELF_ADDR_A_REG);
      attr_err = 1'b1;
    end

    if ((attr_test == 1'b1) ||
        ((SELF_ADDR_B_REG < 11'h000) || (SELF_ADDR_B_REG > 11'h7FF))) begin
      $display("Error: [Unisim %s-135] SELF_ADDR_B attribute is set to %h.  Legal values for this attribute are 11'h000 to 11'h7FF. Instance: %m", MODULE_NAME, SELF_ADDR_B_REG);
      attr_err = 1'b1;
    end

    if ((attr_test == 1'b1) ||
        ((SELF_MASK_A_REG < 11'h000) || (SELF_MASK_A_REG > 11'h7FF))) begin
      $display("Error: [Unisim %s-136] SELF_MASK_A attribute is set to %h.  Legal values for this attribute are 11'h000 to 11'h7FF. Instance: %m", MODULE_NAME, SELF_MASK_A_REG);
      attr_err = 1'b1;
    end

    if ((attr_test == 1'b1) ||
        ((SELF_MASK_B_REG < 11'h000) || (SELF_MASK_B_REG > 11'h7FF))) begin
      $display("Error: [Unisim %s-137] SELF_MASK_B attribute is set to %h.  Legal values for this attribute are 11'h000 to 11'h7FF. Instance: %m", MODULE_NAME, SELF_MASK_B_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-138] USE_EXT_CE_A attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, USE_EXT_CE_A_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-139] USE_EXT_CE_B attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, USE_EXT_CE_B_REG);
      attr_err = 1'b1;
    end
...
// data/cas reg
  ...
  always @ (posedge CLK_in or posedge RST_A_async /* or glblGSR*/ ) begin
    if (RST_A_in /* || glblGSR */ ||
        a_sleep || DEEPSLEEP_in || SLEEP_in || shut_down || SHUTDOWN_in) begin
      RDACCESS_A_int = 1'b0;
    end else begin
...
// data out mux
  ...
  always @ (*) begin
    if (RST_A_async || RST_A_sync || shut_down || a_sleep /* || glblGSR*/ ) begin
      DBITERR_A_out = 1'b0;
      SBITERR_A_out = 1'b0;
    end else if (((CASCADE_ORDER_A_BIN == CASCADE_ORDER_A_MIDDLE) ||
                  (CASCADE_ORDER_A_BIN == CASCADE_ORDER_A_LAST)) &&
  ...
  always @ (posedge CLK_in or posedge RST_A_async /* or glblGSR */) begin
    if (RST_A_in || auto_sleep || a_sleep || SLEEP_in || DEEPSLEEP_in || shut_down || SHUTDOWN_in /* || glblGSR */) begin
      data_A_enable <= 1'b0;
  ...
  always @ (posedge CLK_in or posedge RST_B_async /* or glblGSR */) begin
    if (RST_B_in || auto_sleep || a_sleep || SLEEP_in || DEEPSLEEP_in || shut_down || SHUTDOWN_in /* || glblGSR*/ ) begin
      data_B_enable <= 1'b0;
  ...
  always @ (*) begin
    if (RST_B_async || RST_B_sync || shut_down || a_sleep /* || glblGSR */) begin
      DBITERR_B_out = 1'b0;
      SBITERR_B_out = 1'b0;
    end else if (((CASCADE_ORDER_B_BIN == CASCADE_ORDER_B_MIDDLE) ||
                  (CASCADE_ORDER_B_BIN == CASCADE_ORDER_B_LAST)) &&
  ...
  always @ (posedge CLK_in or posedge RST_A_async /* or glblGSR */) begin
    if (RST_A_in /* || glblGSR */ || (OREG_ECC_A_BIN == OREG_ECC_A_FALSE)) begin
      DOUT_A_reg <= D_INIT;
    end else if (~a_sleep && ~shut_down && data_A_enable) begin
  ...
  always @ (posedge CLK_in or posedge RST_B_async /* or glblGSR */) begin
    if (RST_B_in /* || glblGSR */ || (OREG_ECC_B_BIN == OREG_ECC_B_FALSE)) begin
      DOUT_B_reg <= D_INIT;
    end else if (~a_sleep && ~shut_down && data_B_enable) begin
...
// ram oreg
  ...
  always @ (posedge CLK_in or posedge RST_A_async or shut_down /* or glblGSR */) begin
    if (RST_A_in || shut_down || a_sleep /* || glblGSR */ || (OREG_A_BIN == OREG_A_FALSE)) begin
  ...
  always @ (posedge CLK_in or posedge RST_B_async or shut_down /* or glblGSR */) begin
    if (RST_B_in || shut_down || a_sleep /* || glblGSR */ || (OREG_B_BIN == OREG_B_FALSE)) begin
  ...
  always @ (*) begin
    ...
    ram_ce_a_fifo_in[AUTO_SLEEP_LATENCY_BIN] = &(~(ADDR_A_int[22:12] ^ SELF_ADDR_A_BIN) | SELF_MASK_A_BIN) && EN_A_int;
  end
  always @ (posedge CLK_in /* or glblGSR */) begin
  ...
  always @ (*) begin
    if (EN_AUTO_SLEEP_MODE_BIN == EN_AUTO_SLEEP_MODE_FALSE) begin
      ram_ce_a_int = &(~(ADDR_A_int[22:12] ^ SELF_ADDR_A_BIN) | SELF_MASK_A_BIN) && EN_A_int;
    end else begin
      ram_ce_a_int = ram_ce_a_fifo[1]; 
    end
  end
  ...
  always @ (*) begin
    ...
    ram_ce_b_fifo_in[AUTO_SLEEP_LATENCY_BIN] = &(~(ADDR_B_int[22:12] ^ SELF_ADDR_B_BIN) | SELF_MASK_B_BIN) && EN_B_int;
  end
  always @ (posedge CLK_in /* or glblGSR */) begin
    if (/* glblGSR || */ (EN_AUTO_SLEEP_MODE_BIN == EN_AUTO_SLEEP_MODE_FALSE)) begin
      ram_ce_b_fifo <= 15'b0;
  ...
  always @ (*) begin
    if (EN_AUTO_SLEEP_MODE_BIN == EN_AUTO_SLEEP_MODE_FALSE) begin
      ram_ce_b_int =  &(~(ADDR_B_int[22:12] ^ SELF_ADDR_B_BIN) | SELF_MASK_B_BIN) && EN_B_int;
    end else begin
      ram_ce_b_int = ram_ce_b_fifo[1]; 
    end
  end
...
// ram
  always @ (*) begin
    if ((auto_sleep || SHUTDOWN_in || DEEPSLEEP_in) ||
...
//  always @ (*) begin
//    if (~ram_we_a && ram_ce_a && (USE_EXT_CE_A_BIN == USE_EXT_CE_A_TRUE)) begin
//     ram_data_a_hold = ram_data_a_lat;
//    end
//  end

//  always @ (posedge CLK_in) begin
//    if ((USE_EXT_CE_A_BIN == USE_EXT_CE_A_TRUE) && 
//        ((~OREG_CE_A_in && RDACCESS_A_lat) || OREG_CE_A_in)) begin
//      RDACCESS_A_hold <= RDACCESS_A_lat;
//    end
//  end

// for ecc injection tesing
  always @ (*) begin
...
`ifdef XIL_TIMING
    ...
    $setuphold (negedge CLK, negedge SHUTDOWN, 0:0:0, 0:0:0, notifier, clk_en_n, clk_en_n, CLK_delay, SHUTDOWN_delay);
    ...
    $setuphold (negedge CLK, posedge SHUTDOWN, 0:0:0, 0:0:0, notifier, clk_en_n, clk_en_n, CLK_delay, SHUTDOWN_delay);
    ...
    $setuphold (posedge CLK, negedge SHUTDOWN, 0:0:0, 0:0:0, notifier, clk_en_p, clk_en_p, CLK_delay, SHUTDOWN_delay);
    ...
    $setuphold (posedge CLK, posedge SHUTDOWN, 0:0:0, 0:0:0, notifier, clk_en_p, clk_en_p, CLK_delay, SHUTDOWN_delay);
