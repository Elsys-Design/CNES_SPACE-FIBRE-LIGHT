...
Data_read_general_control = Data.build_empty(0x0C, 4)
...
class TB(common.TB):
    ...
    def __init__(self, dut):
        ...
        names = {
                ...
                "S_GEN_AXI": [AxiLiteBus, AxiLiteMaster, AxiLiteMonitor], 
                "S_ANA_AXI": [AxiLiteBus, AxiLiteMaster, AxiLiteMonitor]
        }
    ...
    async def reset(self):
        ...
        Data_read_general_control.data = bytearray( [0x00,0x00,0x00,0x00])
    ...
    async def reset_DUT(self):
        """
        Active reset of the DUTh for 10 ns. 
        Release DUT reset.
        """
        Data_read_general_control.data = bytearray( [0x00,0x00,0x00,0x00])
        await self.masters[0].write_data(Data_read_general_control)
