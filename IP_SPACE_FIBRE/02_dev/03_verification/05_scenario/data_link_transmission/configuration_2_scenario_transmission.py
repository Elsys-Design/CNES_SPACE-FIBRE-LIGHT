...
async def cocotb_run(dut):
    ...
    await configure_gen_vc_dl([0xE1,0x1F,0x00,0x00], [0x00,0x00,0x00,0x00])
    ...
    for target in range(8):
        await tb.spacefibre_random_generator_data_link.write_random_inputs("reference/spacefibre_serial/step_2_2_" + str(target), 160, 15, 160, 0, target, 5*target + 24, delay = 0, invert_polarity = 0, seed = 43)
